...
export const Dashboard = () => {
  ...
  const handleLogout = async () => {
    try {
      setShowMenu(false);
      await logout();
      // Force a full page reload to the landing page with correct base path
  ...
  const FeatureHeader = () => (
    <header className="dashboard-header">
      <div className="dashboard-header-content">
        <div className="dashboard-logo" onClick={() => setActiveFeature(null)}>
          ...
          <div className="hamburger-menu" ref={menuRef}>
            ...
            {showMenu && (
              <div className="hamburger-dropdown">
                ...
                <button className="hamburger-item" onClick={() => { setActiveFeature(null); setShowMenu(false); }}>
